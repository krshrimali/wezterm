...
impl FilePath {
    ...
    // TODO: @krshrimali - check what is this used for
    ...
    pub fn new_implicit<S: Into<String>>(
        uri: S,
        line_number: Option<i32>,
        column_number: Option<i32>,
    ) -> Self {
    ...
    pub fn parse(osc: &[&[u8]]) -> Result<Option<FilePath>> {
        ...
        log::info!("osc: {:?}", osc);
        let uri = String::from_utf8(osc[1].to_vec())?;
...
mod test {
    ...
    fn parse_implicit() {
        ...
        assert_eq!(
            Rule::match_text("file://home/krshrimali/Documents/main.rs", &rules),
            vec![RuleMatch {
                range: 1..2,
                link: Arc::new(HyperLink::new_implicit("file://home/krshrimali/Documents/main.rs")),
            }]
        );
    }
}
